...
class SafeBox {
    ...
    func addCredentials(withTitle title:String, login: String, password: String, email: String, url:String, detail: String, credentialId: String) -> Credentials {
